...
- table:
  - rowgroup:
    - 'row "Advertisement DEVELOPER TIP! FACT: Internet Explorer lets you customize the look of cursors on your pages. TIP: Our CSS Cursor Tutorial will teach you how extremely easy it is!"':
      - cell
      - cell
      - cell
      - cell "Advertisement":
                            ...
                            - row "Advertisement":
                              - cell "Advertisement":
                                - insertion:
                                  - iframe
      - cell
      - 'cell "DEVELOPER TIP! FACT: Internet Explorer lets you customize the look of cursors on your pages. TIP: Our CSS Cursor Tutorial will teach you how extremely easy it is!"':
        - table:
          - rowgroup:
            - 'row "DEVELOPER TIP! FACT: Internet Explorer lets you customize the look of cursors on your pages. TIP: Our CSS Cursor Tutorial will teach you how extremely easy it is!"':
              - 'cell "DEVELOPER TIP! FACT: Internet Explorer lets you customize the look of cursors on your pages. TIP: Our CSS Cursor Tutorial will teach you how extremely easy it is!"':
                - separator
                - table:
                  - rowgroup:
                    - row "DEVELOPER TIP!":
                      - cell "DEVELOPER TIP!"
                    - 'row "FACT: Internet Explorer lets you customize the look of cursors on your pages. TIP: Our CSS Cursor Tutorial will teach you how extremely easy it is!"':
                      - 'cell "FACT: Internet Explorer lets you customize the look of cursors on your pages. TIP: Our CSS Cursor Tutorial will teach you how extremely easy it is!"':
                        - text: "FACT: Internet Explorer lets you customize the look of cursors on your pages. TIP: Our"
                        - link "CSS Cursor Tutorial":
                          - /url: csscursors.htm
                        - text: will teach you how extremely easy it is!
      - cell
- table:
  - rowgroup:
    - row:
