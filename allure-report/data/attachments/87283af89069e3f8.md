...
- Name: Javascript Alert, confirm, Prompt in Playwright >> JS Alert Validate Alert Text and Click OK
- Location: C:\PlaywrightDemo\tests\PracticeTests\Alerts\alerts.spec.js:9:9
...
Call log:
  - waiting for locator('text= Click for JS Alert')
  ...
  - attempting click action
    ...
    at C:\PlaywrightDemo\tests\PracticeTests\Alerts\alerts.spec.js:12:57
```
